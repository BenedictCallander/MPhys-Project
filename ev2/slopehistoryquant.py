...
def docombine(i):
    try:
        path1 = "files/historycutouts/evdir_{}/slopebreakpoint{}.csv".format(i,i)
        path2 = "files/historycutouts/evdir_{}/historydata_{}.csv".format(i,i)
        df1 = pd.read_csv(path1)
        df2 = pd.read_csv(path2)
        df2.insert(6,"breakrad",df1['breakrad'])
        path = "files/historycutouts/evdir_{}/alldatabreak{}.csv".format(i,i)
        df2.to_csv(path)
...
dfall.to_csv("alldatadonebreak.csv")