...
cax0 = divider0.append_axes('right', size='5%', pad=0.05);cax1 = divider1.append_axes('right', size='5%', pad=0.05)
cax2 = divider2.append_axes('right', size='5%', pad=0.05);cax3 = divider3.append_axes('right', size='5%', pad=0.05)
cax4 = divider4.append_axes('right', size='5%', pad=0.05);cax5 = divider5.append_axes('right', size='5%', pad=0.05)
cax6 = divider6.append_axes('right', size='5%', pad=0.05);cax7 = divider7.append_axes('right', size='5%', pad=0.05)
cax8 = divider8.append_axes('right', size='5%', pad=0.05)


ax0.set_yscale('log')
ax0.set_title("Snap_033: Z=2")
im0 = ax0.scatter((df['mass']),df['sfr'], c = (df['slope']), cmap = 'magma',vmin = min, vmax = max, label = 'Subhalos')
...
im1= ax1.scatter((df2['mass']),df2['sfr'], c = (df2['slope']), cmap = 'magma',vmin = min, vmax = max, label = 'Subhalos')
...
im2 = ax2.scatter((df3['mass']),df3['sfr'], c = (df3['slope']), cmap = 'magma',vmin = min, vmax = max,label = 'Subhalos')
ax2.plot(xvals,line(2,xvals,-20.5),'r-')
ax2.set_ylim(10e-6, 10e2)
ax2.set_xlim(7.5,12)
ax2.set_ylabel("log(SFR) $log_{10}$", math_fontfamily='stix') ;ax2.set_xlabel("Mass $log_{10} M_{sun}$")

ax3.set_ylabel("12+$log_{10}(O/H)$")
ax3.set_xlabel("Mass $log_{10} M_{sun}$")
#ax3.set_yscale('log')
ax3.set_title("Metallicity 33: Z=2")
im3 = ax3.scatter((df['mass']),12+np.log10(df['met']), c = (df['slope']), cmap = 'magma',vmin = min, vmax = max, label = 'Main Sequence Subhalos')
ax3.set_ylim(0,12)
ax3.set_xlim(7.5,12)

#ax4.set_yscale('log')
ax4.set_title("Metallicity 67: Z=0.5")
im4 = ax4.scatter((df2['mass']),12+np.log10(df2['met']), c = (df2['slope']), cmap = 'magma',vmin = min, vmax = max, label = 'Main Sequence Subhalos')
...
im5 = ax5.scatter((df3['mass']),12+np.log10(df3['met']), c = (df3['slope']), cmap = 'magma',vmin = min, vmax = max, label = 'Main Sequence Subhalos')
ax5.set_ylim(0,12)
ax5.set_xlim(7.5,12)

ax6.set_yscale('log')
ax6.set_title("Snap_033: Z=2")
im6 = ax6.scatter((MS1['mass']),MS1['sfr'], c = MS1['slope'], cmap = 'magma',vmin = min, vmax = max, label = 'Main Sequence Subhalos')
ax6.plot(xvals,line(2,xvals,-20.5),'r-')
ax6.set_ylim(10e-6, 10e2)
ax6.set_xlim(7.5,12)
ax6.set_ylabel("$log_{10}$(SFR)") ; ax6.set_xlabel("Mass $log_{10} M_{sun}$")

ax7.set_yscale('log')
ax7.set_title("Snap_033: Z=2")
im7 = ax7.scatter((MS2['mass']),MS2['sfr'], c = MS2['slope'], cmap = 'magma',vmin = min, vmax = max,label = 'Main Sequence Subhalos')
ax7.plot(xvals,line(2,xvals,-20.5),'r-')
ax7.set_ylim(10e-6, 10e2)
ax7.set_xlim(7.5,12)
ax7.set_ylabel("$log_{10}$(SFR)") ; ax7.set_xlabel("Mass $log_{10} M_{sun}$")

ax8.set_yscale('log')
ax8.set_title("Snap_033: Z=2")
im8 = ax8.scatter((MS3['mass']),MS3['sfr'], c =MS3['slope'], cmap = 'magma',vmin = min, vmax = max, label = 'Main Sequence Subhalos')
ax8.plot(xvals,line(2,xvals,-20.5),'r-')
ax8.set_ylim(10e-6, 10e2)
ax8.set_xlim(7.5,12)
ax8.set_ylabel("$log_{10}$(SFR)") ; ax8.set_xlabel("Mass $log_{10} M_{sun}$")
