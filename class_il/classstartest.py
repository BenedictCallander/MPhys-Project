...
print(np.ndim(sub0.pstar_coo))
print(np.ndim(sub0.pstar_m))
x= sub0.pstar_coo[:,0]
y= sub0.pstar_coo[:,1]
dens = (sub0.pstar_m)
plt.figure()
...
plt.close()
#df = pd.DataFrame({"x": sub0.pstar_coo[:,0],"y": sub0.pstar_coo[:,1],"z": sub0.pstar_coo[:,2],"m": sub0.pgas_m})
#df2=df.round(2)
#df2.sort_values(by='x',inplace=True)
#df2.to_csv('filet2.csv')
print(dens)
print(min(sub0.pstar_coo[:,0]))
print(max(sub0.pstar_coo[:,0]))
#
print(min(sub0.pstar_coo[:,1]))
print(max(sub0.pstar_coo[:,1]))
#
print(min(sub0.pstar_coo[:,2]))
print(max(sub0.pstar_coo[:,2]))