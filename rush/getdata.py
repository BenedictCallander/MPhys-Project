...
baseurl = "https://www.tng-project.org/api/TNG50-1/snapshots/33/subhalos/?limit=77655&sfr__gt=0.0"
sfrsubs = get(baseurl)
...
def get_data(i):
    url = "https://www.tng-project.org/api/TNG50-1/snapshots/33/subhalos/{}".format(i)
    sub = get(url)
    mass_half = sub['massinhalfrad']
