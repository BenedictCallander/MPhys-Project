# Extract particle level data and compute galaxy centre, angular momentum and align z-axis to angular momentum vector.
...
#Defining the class which will contain all the galaxy properties: imported ones and newly calculated ones
class galaxy(object):
