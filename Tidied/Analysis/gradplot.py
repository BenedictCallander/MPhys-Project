...
im0 = ax0.scatter((df['mass']),df['sfr'], c = (df1['slope']), cmap = 'magma',vmax =7,vmin=5, label = 'Subhalos')
...
im1= ax1.scatter((df2['mass']),df2['sfr'], c = (df3['slope']), cmap = 'magma',vmin = 7,  label = 'Subhalos')
...
im2 = ax2.scatter((df4['mass']),df4['sfr'], c = (df5['slope']), cmap = 'magma',vmin =7, label = 'Subhalos')
