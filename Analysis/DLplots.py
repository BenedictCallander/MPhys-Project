...
im3 = ax3.scatter((MS1['mass']),12+np.log10(MS1['met']), c = (MS1['slope']), cmap = 'magma',vmin=4, label = 'Main Sequence Subhalos')
ax3.set_ylim(0,12)
ax3.text(10,4,"Number of Subhalos = {}".format(Num1),fontsize=15)
ax3.set_xlim(7.5,12)

#ax4.set_yscale('log')
ax4.set_title("Metallicity 67: Z=0.5")
im4 = ax4.scatter((MS2['mass']),12+np.log10(MS2['met']), c = (MS2['slope']), cmap = 'magma',vmin=6, label = 'Main Sequence Subhalos')
ax4.set_ylabel("12+$log_{10}(O/H)$")
ax4.set_xlabel("Mass $log_{10} M_{sun}$")
ax4.set_ylim(0,12)
ax4.text(10,4,"Number of Subhalos = {}".format(Num2),fontsize=15)
ax4.set_xlim(7.5,12)
...
im5 = ax5.scatter((MS3['mass']),12+np.log10(MS3['met']), c = (MS3['slope']), cmap = 'magma',vmin=6, label = 'Main Sequence Subhalos')
ax5.set_ylim(0,12)
ax5.text(10,4,"Number of Subhalos = {}".format(Num3),fontsize=15)
ax5.set_xlim(7.5,12)
...
fig.suptitle("Redshift progression of Main Sequence Subhalo Mass-Metallicity relation", fontsize=20)
fig.savefig('png/slopegrads/MASS_met_MAINSEQ_COMB.png')