...
im0 = ax0.scatter((df['mass']),df['sfr'], c = (df1['slope']), cmap = 'magma',vmin = 8,label = 'Main Sequence Subhalos')
...
im1= ax1.scatter((df2['mass']),df2['sfr'], c = (df3['slope']), cmap = 'magma',vmin=5,vmax=9,label = 'Main Sequence Subhalos')
...
im2 = ax2.scatter((df4['mass']),df4['sfr'], c = (df5['slope']), cmap = 'magma',vmin=5,vmax=9, label = 'Main Sequence Subhalos')
...
im3 = ax3.scatter((df['mass']),df1['met'], c = (df1['slope']), cmap = 'magma',vmin =7, label = 'Main Sequence Subhalos')
ax3.set_ylim(10e-8, 10e2)
ax3.set_xlim(7.5,12)

#ax4.set_yscale('log')
ax4.set_title("Metallicity 67: Z=0.5")
im4 = ax4.scatter((df2['mass']),df3['met'], c = (df3['slope']), cmap = 'magma',vmin=5,vmax=9, label = 'Main Sequence Subhalos')
ax4.set_ylim(10e-8, 10e2)
ax4.set_xlim(7.5,12)

#ax5.set_yscale('log')
ax5.set_title(" Metallicity 99: Z=0 ")
im5 = ax5.scatter((df4['mass']),df5['met'], c = (df5['slope']), cmap = 'magma',vmin=5,vmax=9, label = 'Main Sequence Subhalos')
ax5.set_ylim(10e-8, 10e2)
ax5.set_xlim(7.5,12)

ax6.set_yscale('log')
ax6.set_title("Snap_033: Z=2")
im6 = ax6.scatter((MS1['mass']),MS1['sfr'], c = MS1['slope'], cmap = 'magma',vmin=2,vmax = 5.5, label = 'Main Sequence Subhalos')
...
im7 = ax7.scatter((MS2['mass']),MS2['sfr'], c = MS2['slope'], cmap = 'magma',vmin=3,vmax = 8,  label = 'Main Sequence Subhalos')
...
im8 = ax8.scatter((MS3['mass']),MS3['sfr'], c =MS3['slope'], cmap = 'magma',vmin=3,vmax = 8, label = 'Main Sequence Subhalos')
