...
im0 = ax0.scatter((df['mass']),df['sfr'], c = (df1['slope']), cmap = 'magma',vmin =6, label = 'Main Sequence Subhalos')
...
im1= ax1.scatter((df2['mass']),df2['sfr'], c = (df3['slope']), cmap = 'magma',vmax = 7, label = 'Main Sequence Subhalos')
...
im2 = ax2.scatter((df4['mass']),df4['sfr'], c = (df5['slope']), cmap = 'magma',vmax =7, label = 'Main Sequence Subhalos')
