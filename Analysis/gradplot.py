...
im3 = ax3.scatter((df['mass']),df1['met'], c = (df1['slope']), cmap = 'magma', label = 'Main Sequence Subhalos')
...
im6 = ax6.scatter((MS1['mass']),MS1['sfr'], c = np.log10(abs(MS1['slope'])), cmap = 'magma', label = 'Main Sequence Subhalos')
...
im7 = ax7.scatter((MS2['mass']),MS2['sfr'], c = np.log10(abs(MS2['slope'])), cmap = 'magma',  label = 'Main Sequence Subhalos')
...
im8 = ax8.scatter((MS3['mass']),MS3['sfr'], c = np.log10(abs(MS3['slope'])), cmap = 'magma', label = 'Main Sequence Subhalos')
